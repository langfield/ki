...
from ki import MEDIA, LCA, _clone1
...
def test_push_is_trivial_for_committed_submodule_contents():
    ...
    # Clone collection in cwd.
    out = clone(UNCOMMITTED_SM.col_file)
