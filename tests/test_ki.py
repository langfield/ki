...
@beartype
def test_fails_without_ki_subdirectory(runner: CliRunner, tmp_path: Path):
...
@beartype
def test_computes_and_stores_md5sum(runner: CliRunner, col_file: ki.ExtantFile, tmp_path: Path):
